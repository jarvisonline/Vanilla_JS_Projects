let fromInputBox = document.querySelector(
  ".container .from-to .from .from-input"
);
let toInputBox = document.querySelector(".container .from-to .to .to-input");
let fromOptionsBox = document.querySelector(
  ".container .from-to .from .from-country-options"
);
let toOptionsBox = document.querySelector(
  ".container .from-to .to .to-country-options"
);
let fromInputFlag = document.querySelector(
  ".container .from-to .from .from-flag img"
);
let toInputFlag = document.querySelector(
  ".container .from-to .to .to-flag img"
);
...
let apiKey = "747bad5ee4745b2e359c6ddf";
